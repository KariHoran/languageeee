...
const ru: Dictionary = {
  ...
  'unit.word.few': 'слова',
  'unit.word.many': 'слов',
  'unit.card.one': 'карточка',
  'unit.card.few': 'карточки',
  'unit.card.many': 'карточек',
  'unit.minute.one': 'минута',
  'unit.minute.few': 'минуты',
  'unit.minute.many': 'минут',
  'unit.text.one': 'текст',
  'unit.text.few': 'текста',
  'unit.text.many': 'текстов',
  ...
  'profile.cardsInDeck': 'В колоде: {n}',
  'profile.weekLine': '{words} · {cards} за неделю',
  'profile.activityTitle': 'Активность',
  'profile.activityDay': '{words} · {cards}',
...
'alert.deleteFanficNamed': 'Удалить «{title}»? Это действие нельзя отменить.',
  ...
  'flashcards.startSession': 'Начать сессию · {n}',
  ...
  'progress.weekStats': '{words} · {cards} · {min}',
...
'alert.deleteFanficNamed': 'Delete "{title}"? This cannot be undone.',
  ...
  'flashcards.startSession': 'Start session · {n}',
...
const zh: Dictionary = {
  ...
  'profile.goHome': '返回首页',
  'profile.cardsInDeck': '卡组：{n}',
  'profile.weekLine': '本周 {words} · {cards}',
...
'alert.deleteFanficNamed': '删除「{title}」？此操作无法撤销。',
  ...
  'flashcards.startSession': '开始练习 · {n}',
